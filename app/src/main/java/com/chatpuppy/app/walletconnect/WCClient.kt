...
import com.chatpuppy.app.walletconnect.entity.*
import com.chatpuppy.app.walletconnect.util.WCCipher
import com.chatpuppy.app.walletconnect.util.toByteArray
...
open class WCClient : WebSocketListener() {
    ...
    private fun handleRequest(request: JsonRpcRequest<JsonArray>) {
        ...
        when (request.method) {
            ...
            WCMethod.ETH_DECRYPT -> {
                handleDecrypt(request)
            }
            else -> {}
        }
    }

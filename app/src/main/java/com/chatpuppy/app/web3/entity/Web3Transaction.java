...
import com.chatpuppy.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable {
     ...
     * @param minGas
     */
    public Web3Transaction(com.chatpuppy.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {

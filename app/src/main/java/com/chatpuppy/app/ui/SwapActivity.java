...
import com.chatpuppy.app.entity.lifi.Chain;
import com.chatpuppy.app.entity.lifi.Connection;
import com.chatpuppy.app.entity.lifi.Quote;
import com.chatpuppy.app.entity.lifi.Token;
import com.chatpuppy.app.ui.widget.entity.ActionSheetCallback;
import com.chatpuppy.app.ui.widget.entity.ProgressInfo;
import com.chatpuppy.app.util.BalanceUtils;
import com.chatpuppy.app.util.SwapUtils;
import com.chatpuppy.app.viewmodel.SwapViewModel;
import com.chatpuppy.app.viewmodel.Tokens;
...
import com.chatpuppy.app.widget.SelectTokenDialog;
import com.chatpuppy.app.widget.StandardHeader;
import com.chatpuppy.app.widget.SwapSettingsDialog;
import com.chatpuppy.app.widget.TokenInfoView;
import com.chatpuppy.app.widget.TokenSelector;
...
public class SwapActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private com.chatpuppy.app.entity.tokens.Token token;
    ...
    private ActionSheetDialog createConfirmationAction(Quote quote)
    {
        ...
        try
        {
            com.chatpuppy.app.entity.tokens.Token activeToken = viewModel.getTokensService().getTokenOrBase(sourceToken.chainId, sourceToken.address);

...
import static com.chatpuppy.app.C.ADDED_TOKEN;
import static com.chatpuppy.app.C.CHANGED_LOCALE;
import static com.chatpuppy.app.C.CHANGE_CURRENCY;
import static com.chatpuppy.app.C.RESET_TOOLBAR;
import static com.chatpuppy.app.C.RESET_WALLET;
import static com.chatpuppy.app.C.SETTINGS_INSTANTIATED;
import static com.chatpuppy.app.C.SHOW_BACKUP;
import static com.chatpuppy.app.entity.WalletPage.ACTIVITY;
import static com.chatpuppy.app.entity.WalletPage.CHATPUPPY;
import static com.chatpuppy.app.entity.WalletPage.DAPP_BROWSER;
import static com.chatpuppy.app.entity.WalletPage.SETTINGS;
import static com.chatpuppy.app.entity.WalletPage.WALLET;
...
import com.chatpuppy.app.api.v1.entity.request.ApiV1Request;
...
import com.chatpuppy.app.entity.HomeCommsInterface;
import com.chatpuppy.app.entity.HomeReceiver;
import com.chatpuppy.app.entity.SignAuthenticationCallback;
import com.chatpuppy.app.entity.Wallet;
import com.chatpuppy.app.entity.WalletPage;
...
import com.chatpuppy.app.viewmodel.BaseNavigationActivity;
...
import com.chatpuppy.app.widget.AWalletConfirmationDialog;
...
//        viewModel.tryToShowEmailPrompt(this, successOverlay, handler, this);
    ...
    protected void onResume() {
        ...
        notificationManager.cancel(850708);
...
//        checkWarnings();
    ...
    public void onBackPressed() {
        ...
        } else if (viewPager.getCurrentItem() == CHATPUPPY.ordinal()) {
            getFragment(CHATPUPPY).backPressed();
